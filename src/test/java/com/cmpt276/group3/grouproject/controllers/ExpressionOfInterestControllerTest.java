...
@org.springframework.boot.webmvc.test.autoconfigure.WebMvcTest(
        ExpressionOfInterestController.class
)
public class ExpressionOfInterestControllerTest {
    ...
    void eoisPage_redirectsToLoginWhenNotAuthenticated() throws Exception {
        ...
        mockMvc.perform(get("/eois").session(session))
    ...
    void eoisPage_displaysReceivedEOIsForCurrentUser() throws Exception {
        ...
        when(expressionOfInterestRepository
